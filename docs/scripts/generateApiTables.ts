...
const tableConfigs: Array<TableConfig> = [
  ...
  {
    targetName: 'SignalSingleQueryOptions',
    memberType: 'properties',
    outputFilename: 'SignalSingleQueryOptions.md'
  },
  {
    targetName: 'SignalSingleQuery',
    memberType: 'properties',
    headers: ['Signal', 'Type', 'Description'],
    memberFilter: {
      kind: 'Property',
    ...
    outputFilename: 'SignalSingleQuerySignals.md'
  },
  {
    targetName: 'SignalSingleQuery',
    memberType: 'methods',
    outputFilename: 'SignalSingleQueryMethods.md'
  },
  {
