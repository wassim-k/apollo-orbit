...
## Usage
As stated previously in the [`mutations guide`](../../fetching/mutations/#cache-normalisation), unlike `UpdateBookMutation`, updating the cache after executing `AddBookMutation` requires manual intervention.
