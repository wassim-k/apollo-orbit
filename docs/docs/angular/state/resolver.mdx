...
## Overview
`resolver` is analogous to <Link to="https://www.apollographql.com/docs/react/api/core/ApolloClient#apolloclientoptions-resolvers">`resolvers`</Link> option passed to `ApolloOptions`.  
