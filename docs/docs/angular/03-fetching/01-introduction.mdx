...
| :------------------------------------------------------------- | :-------------------------------------------------------------------------   | :-----------------------------------------------------------------------------------------------|
| <Link to="../queries/watchQuery#query">`query`</Link>          | <Link to="../queries/signal.query.once">`signal.query.once`</Link>           | Executes a one-time query without watching the cache for updates.                               |
