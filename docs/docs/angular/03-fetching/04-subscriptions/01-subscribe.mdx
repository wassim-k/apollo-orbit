...
Saving *author.graphql* will trigger codegen of `NEW_AUTHOR_SUBSCRIPTION` typed gql document in */graphql/operations.ts* file as per our setup.
...
import { NewAuthorSubscription } from '../graphql';
