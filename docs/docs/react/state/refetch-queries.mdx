...
## Overview
`refetchQueries` is analogous to <Link to="https://www.apollographql.com/docs/react/data/mutations/#mutationhookoptions-interface-refetchqueries">`refetchQueries`</Link> option passed to `useMutation`.  
