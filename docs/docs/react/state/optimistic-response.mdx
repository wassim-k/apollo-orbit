...
## Overview
`optimisticResponse` is analogous to <Link to="https://www.apollographql.com/docs/react/data/mutations/#mutationhookoptions-interface-optimisticresponse">`optimisticResponse`</Link> option passed to `useMutation`.  
