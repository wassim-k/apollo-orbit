...
export type BookFragment = { __typename: 'Book', id: string, name: string, genre: _.Maybe<string> };
...
export type BooksQueryData = { __typename?: 'Query', books: Array<{ __typename: 'Book', id: string, name: string, genre: _.Maybe<string> }> };
...
export type BookQueryData = { __typename?: 'Query', book: { __typename: 'Book', id: string, name: string, genre: _.Maybe<string> } };
...
export type AddBookMutationData = { __typename?: 'Mutation', addBook: _.Maybe<{ __typename: 'Book', id: string, name: string, genre: _.Maybe<string> }> };

export type NewBookSubscriptionVariables = _.Exact<{ [key: string]: never; }>;


export type NewBookSubscriptionData = { __typename?: 'Subscription', newBook: { __typename: 'Book', id: string, name: string, genre: _.Maybe<string> } };
...
export type NewBookByAuthorSubscriptionData = { __typename?: 'Subscription', newBook: { __typename: 'Book', id: string, name: string, genre: _.Maybe<string> } };
