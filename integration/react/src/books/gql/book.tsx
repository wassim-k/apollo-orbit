...
export type BooksQuery = { __typename?: 'Query', books: Array<{ __typename: 'Book', id: string, name: string, genre: _.Maybe<string>, displayName: string }> };
...
export type BookQuery = { __typename?: 'Query', book: { __typename: 'Book', id: string, name: string, genre: _.Maybe<string>, displayName: string } };
...
export type AddBookMutation = { __typename?: 'Mutation', addBook: _.Maybe<{ __typename: 'Book', id: string, name: string, genre: _.Maybe<string>, displayName: string }> };

export type NewBookSubscriptionVariables = _.Exact<{ [key: string]: never; }>;


export type NewBookSubscription = { __typename?: 'Subscription', newBook: { __typename: 'Book', id: string, name: string, genre: _.Maybe<string>, displayName: string } };
...
export type NewBookByAuthorSubscription = { __typename?: 'Subscription', newBook: { __typename: 'Book', id: string, name: string, genre: _.Maybe<string>, displayName: string } };
